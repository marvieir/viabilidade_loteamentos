...
def _propor_impl(
    ...
    *,
    ...
    diretrizes = resolver_diretrizes(
        ...
        doacao_verde_pct=getattr(body, "doacao_verde_pct", None),
        doacao_inst_pct=getattr(body, "doacao_inst_pct", None),
    )
    ...
    salvo["_contexto_variantes"] = {
        ...
        "lote_min_m2": getattr(body, "lote_min_m2", None),
        "doacao_verde_pct": getattr(body, "doacao_verde_pct", None),  # URB-DOA
        "doacao_inst_pct": getattr(body, "doacao_inst_pct", None),
