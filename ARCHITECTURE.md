...
```
Concluídas (validadas):  1 → 1.5 → 1.7 → 2.1 → 2.2 → 2.3 → 1.8 → 2.5
...
11. Fase 3 — Jurídica (perfil municipal/estadual; consome o que a 1.8 extraiu — `frente_min`,
    `ca`, `taxa_ocupacao`, `doacao_split`, + camada federal/estadual). **A especificar:**
    pedido de spec em `docs/handoff-fase-3-pedido-spec.md`.
