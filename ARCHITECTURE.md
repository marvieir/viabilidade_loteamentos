...
```
Concluídas (validadas):  1 → … → 4 → 4.1 → 4.2 → 5 → 6 → 7 → 8 → 9 → 9.1 → 9.4 → 9.5
Próximas (nesta ordem):  Nível 2 (traçado orgânico: vias seguindo relevo, quadras orgânicas) · Custos (SINAPI/SICRO) · Técnica/Operacional/Mercadológica/Política · Estadual
