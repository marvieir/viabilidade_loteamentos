...
```
Concluídas (validadas):  1 → … → 4 → 4.1 → 4.2 → 5 → 6 → 7 → 8 → 9 → 9.1 → 9.4 → 9.5 → 9.6
Próximas (nesta ordem):  9.7 viário-MALHA (Nível 2: viário-por-traçado, eixos conectados, quadras nascendo da malha) · pórtico · Custos (SINAPI/SICRO) · Técnica/Operacional/Mercadológica/Política · Estadual
